...
export class SliderX {
  ...
  updateSliderStyle() {
    ...
    el.querySelector('ol.mpslider-pagination').style.display = paginationDisplay
  }
  ...
  updateSliderCtrlStyle(index) {
    ...
    const $next = el.querySelector('.mpnext-nav')
    const $prev = el.querySelector('.mpprev-nav')
  ...
  udpateActiveSlideStyle() {
    ...
    const $currLi = this.el.querySelector('ol.mpslider-pagination li.active')
